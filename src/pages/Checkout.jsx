    ...
    <>
      <div className="container mx-auto px-4 md:px-8 pt-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          <div className="lg:col-span p-8 bg-gray-900 rounded-2xl shadow-2xl border border-gray-800">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="pt-6">
                <button
                  type="submit"
                  className="w-full py-4 bg-orange-600 text-white font-extrabold text-xl rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 trnasform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider"
                >
