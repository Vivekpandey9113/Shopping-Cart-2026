...
<p>{deliveryDetails?.city},{deliveryDetails?.zip}</p>
 ...
 <Link to={"/"}
             className="mt-10 px-4 py-4 bg-orange-600 text-white font-extrabold rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 trnasform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider">
              Continue Shopping
             </Link>
